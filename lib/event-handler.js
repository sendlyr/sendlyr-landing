...
const allowedEvents = new Set(["page_view", "navigation_click", "workflow_open", "case_study_open", "book_sprint_click", "cohort_toggle", "proof_tab_change", "decision_trace_change"]);
...
const allowedDestinations = new Set([...allowedPaths, "/#decision-layer"]);
...
function validateEvent(event) {
  ...
  if (event.properties.href && !allowedDestinations.has(event.properties.href)) return "Invalid event destination.";
...
module.exports = { allowedDestinations, allowedEvents, allowedPaths, buildEvent, handleEventSubmission, hashAddress, isAllowedOrigin, propertySchemas, validateEvent, withinRateLimit };
