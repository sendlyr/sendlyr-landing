create table if not exists public.analytics_events (
  ...
  constraint analytics_event_name_check check (event_name in ('page_view', 'navigation_click', 'workflow_open', 'case_study_open', 'book_sprint_click', 'cohort_toggle', 'proof_tab_change', 'decision_trace_change', 'decision_loop_step', 'journey_archetype_change', 'delivery_path_change')),
...
alter table public.analytics_events add constraint analytics_event_name_check check (event_name in ('page_view', 'navigation_click', 'workflow_open', 'case_study_open', 'book_sprint_click', 'cohort_toggle', 'proof_tab_change', 'decision_trace_change', 'decision_loop_step', 'journey_archetype_change', 'delivery_path_change'));
